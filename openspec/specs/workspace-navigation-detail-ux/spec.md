# workspace-navigation-detail-ux Specification

## Purpose
Destination-aware workspace navigation, scroll/focus behavior on the real main container, and responsive master-detail presentation for incident, playbook, and SOAR operations selections.
