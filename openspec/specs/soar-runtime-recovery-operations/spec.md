# soar-runtime-recovery-operations Specification

## Purpose
Define controlled VM runtime recovery for SOAR workers: secret-safe repair, verified kill-switch behavior, auditable queue/dead-letter/approval disposition, and Mac source-of-truth handoff.
## Requirements
