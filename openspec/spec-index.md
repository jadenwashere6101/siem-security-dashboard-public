...
| SPEC-UI-001 | SOAR Operations UI | `openspec/changes/archive/2026-05-17-add-soar-operations-ui/` | `frontend/src/services/deadLetterService.js`, `frontend/src/components/DeadLettersPanel.js`, `frontend/src/components/PlaybooksPanel.js`, `frontend/src/App.js` |
| SPEC-METRICS-001 | SOAR Metrics Dashboard | `openspec/changes/add-soar-metrics-dashboard/` | `routes/metrics_routes.py`, `frontend/src/services/metricsService.js`, `frontend/src/components/SoarMetricsDashboard.js`, `frontend/src/App.js` |
