...
| SPEC-UI-001 | SOAR Operations UI | `openspec/changes/add-soar-operations-ui/` | `frontend/src/services/deadLetterService.js`, `frontend/src/components/DeadLettersPanel.js`, `frontend/src/components/PlaybooksPanel.js`, `frontend/src/App.js` |
