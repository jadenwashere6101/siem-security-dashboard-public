...
DETECTORS = {
    ...
    "app_insights_unauthorized_access_threshold": detection_engine._generate_app_insights_unauthorized_access_alerts_core,
...
def _insert_event(cur, rule_id, source_ip, source, source_type, *, event_type=None, username="alice"):
    event_types = {
        ...
        "app_insights_unauthorized_access_threshold": "unauthorized_access",
