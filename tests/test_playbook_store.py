...
def test_playbook_schedule_store_surface_is_retired():
    assert not hasattr(playbook_store, "create_playbook_schedule")
    assert not hasattr(playbook_store, "get_playbook_schedule")
    assert not hasattr(playbook_store, "list_playbook_schedules")
