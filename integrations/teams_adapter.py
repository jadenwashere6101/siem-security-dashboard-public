...
# spec: SPEC-INTEG-004 / SPEC-INTEG-005 - Teams is real-capable only after adapter guards pass.
    ...
    def _execute_real_teams(self, action, params, context):
        ...
        if not rate_limit["allowed"]:
            return self._audit_real_attempt(self._result(
                ...
                context,
                success=False,
                message="Teams real-mode send blocked safely by adapter rate limit.",
                metadata={
                    **base_metadata,
